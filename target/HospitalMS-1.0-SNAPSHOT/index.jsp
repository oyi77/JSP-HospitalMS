	...
	<div class="container-fluid">
						...
						<form class="form-horizontal center-block" role="form"
							...
							<div class="col-sm-7 col-sm-offset-2">
								<input type="submit" class="btn btn-primary btn-block btn-lg"
									value="Login"><br>
								<a href="user_register.jsp">New Registration</a>||
								<a href="doctorLogin.jsp">Doctor Login</a>||<a href="patientLogin.jsp">Patient Login</a>
							</div>
		...
		<div class="row footer navbar-fixed-bottom">
			<div class="col-md-12">
				...
				<p>Copyrights © HospitalMS 2021. All rights
					reserved.</p>
			</div>
		</div>
